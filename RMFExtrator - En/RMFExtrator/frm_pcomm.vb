...
Public Class frm_pcomm
    Private Sub frm_pcomm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If File.Exists(Application.CommonAppDataPath.ToString() & "\" & "Buffer.txt") Then
            ...
            Try
                myStreamReader = System.IO.File.OpenText(Application.CommonAppDataPath.ToString() & "\" & "Buffer.txt")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim streamWriter As New IO.StreamWriter(Application.CommonAppDataPath.ToString() & "\" & "Buffer.txt", True)

        While y < 80
            Interlocked.Increment(y)
            EhllapiWrapper.ReadScreen(Convert.ToInt32((y * 80) - 79), Convert.ToInt32(80), str)
            If str.Length >= 80 Then
                'IO.File.AppendAllText(Application.CommonAppDataPath.ToString() & "\" & "Buffer.txt", str.Substring(0, 80) + ControlChars.Cr)
    ...
    Private Sub frm_pcomm_Closed(sender As Object, e As EventArgs) Handles MyBase.Closed
        If File.Exists(Application.CommonAppDataPath.ToString() & "\" & "Buffer.txt") Then
            Form1.txt_entrada.Text = Application.CommonAppDataPath.ToString() & "\" & "Buffer.txt"
        End If
    End Sub
    ...
    Private Sub CapturarProcU(sender As Object, e As EventArgs)
        ...
        While flag2 = False
            ...
            SetToolStripStatusLabel3("Extracting...")
                ...
                If str.Length >= 80 Then
                    ...
                    If str.Substring(0, 80).Contains("Data available only from") Then
                        ...
                        If CheckBox1.Checked = True Then
                            ...
                            'Settxt_entrada(Application.CommonAppDataPath.ToString() & "Buffer.txt")
                            'Form1.AbrirTXT(Application.CommonAppDataPath.ToString() & "Buffer.txt", True)
                            ...
                            SetToolStripStatusLabel3("Waiting for new data...")
            ...
            While flag = False
                ...
                If primeirapag = True Then
                    ...
                    Dim streamWriter2 As New IO.StreamWriter(Application.CommonAppDataPath.ToString() & "\" & "Buffer.txt", True)
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        If NumFim.Value = 1 And NumInicio.Value = 1 Then
            MsgBox("Set the start and end fields of the table to copy.")
            NumInicio.Focus()
            Exit Sub
        End If
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        If (e.Cancelled = True) Then
            SetToolStripStatusLabel3("Extraction stopped")
        Else
            SetToolStripStatusLabel3("Extraction Completed")
        End If
        Button3.Text = "Start Recording"
    End Sub
